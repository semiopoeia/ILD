...
data validay;
keep IDNo Visit n_valid_days date TAC_HiLo;
set blsa (rename=(id=IDNo visit=Visit));
if tac_23to5removed<2004759.02 then TAC_HiLo=0;
if tac_23to5removed>=2004759.02 then TAC_HiLo=1;
format TAC_HiLo TAC_LoHiF.;
run;
*merging;
...
;
   ...
   drop i;
   format sex bmicat comorbidcat TAC_HiLo;
run;
